    ...
    <div class="spmb-hero" style="padding: 45px 0;">
        <div class="spmb-container" style="text-align:center;">
            ...
            <p class="spmb-hero-subtitle" style="margin:0 auto;">
                Masukkan Nomor Registrasi (contoh: <code>REG-SKPR-XXXXX</code>) atau 10 digit NISN calon siswa.
            </p>
        </div>
    </div>
            ...
            <?php if ($notFound): ?>
                <div class="spmb-alert spmb-alert-danger" style="padding:24px;">
                    ...
                    <div>
                        ...
                        Tidak ada pendaftar dengan kata kunci <strong>"<?php echo htmlspecialchars($keyword); ?>"</strong>. Pastikan Anda memasukkan Nomor Pendaftaran (misal <code>REG-SKPR-XXXXX</code>) atau 10 digit NISN yang terdaftar saat mengisi formulir.
